 ...
 * Original file: E:\\AndroidDeveloper\\workspace\\NewStar\\src\\android\\content\\pm\\IPackageManager.aidl
 */
...
case TRANSACTION_setPackageObbPath:
{
data.enforceInterface(DESCRIPTOR);
java.lang.String _arg0;
_arg0 = data.readString();
java.lang.String _arg1;
_arg1 = data.readString();
this.setPackageObbPath(_arg0, _arg1);
reply.writeNoException();
return true;
}
}
...
@Override public void setPackageObbPath(java.lang.String packageName, java.lang.String path) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
mRemote.transact(Stub.TRANSACTION_setPackageObbPath, _data, _reply, 0);
_reply.readException();
}
finally {
_reply.recycle();
...
static final int TRANSACTION_setPackageObbPath = (android.os.IBinder.FIRST_CALL_TRANSACTION + 72);
}
...
public void setPackageObbPath(java.lang.String packageName, java.lang.String path) throws android.os.RemoteException;
}
